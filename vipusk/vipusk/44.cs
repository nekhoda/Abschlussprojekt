...
namespace vipusk
{
    public partial class _44 : Form
    {
        ...
        private void _44_Load(object sender, EventArgs e)
        {
            listBox1.Items.Clear();
            listBox2.Items.Clear();
            listBox3.Items.Clear();
            string myXMLfile = Application.StartupPath + "\\xml\\4\\44.xml";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (j < 12)
            {
                ...
                if (Convert.ToInt32(dataGridView1[3, mas[j]].Value.ToString()) == 1)
                {
                    mark++;
                }
                j++;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (j < 12)
            {
                ...
                if (Convert.ToInt32(dataGridView1[3, mas[j]].Value.ToString()) == 2)
                {
                    mark++;
                }
                j++;

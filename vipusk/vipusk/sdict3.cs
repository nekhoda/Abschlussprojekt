...
namespace vipusk
{
    public partial class sdict3 : Form
    {
        public sdict3()
        {
            InitializeComponent();
        ...
        string verno;
        string[] verno1;
        private void sdict3_Load(object sender, EventArgs e)
        {
            string path = Application.StartupPath;
            richTextBox2.LoadFile(path + "\\dict\\6.rtf");
        ...
        {
            string path = Application.StartupPath;
            axWindowsMediaPlayer1.URL = path + "\\audio\\6.mp4";
        }
    }
}

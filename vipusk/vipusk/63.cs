...
namespace vipusk
{
    public partial class _63 : Form
    {
        ...
        private void _63_Load(object sender, EventArgs e)
        {
            listBox1.Items.Clear();
            listBox2.Items.Clear();
            listBox3.Items.Clear();
            string myXMLfile = Application.StartupPath + "\\xml\\6\\63.xml";

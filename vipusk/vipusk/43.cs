...
namespace vipusk
{
    public partial class _43 : Form
    {
        public _43()
        {
            InitializeComponent();
        }
        int vsego_voprosov_v_tabl = 17;
        ...
        private void _43_Load(object sender, EventArgs e)
        {
            listBox1.Items.Clear();
            listBox2.Items.Clear();
            listBox3.Items.Clear();
            listBox4.Items.Clear();
            string myXMLfile = Application.StartupPath + "\\xml\\4\\43.xml";

...
namespace vipusk
{
    public partial class sdict2 : Form
    {
        public sdict2()
        {
            InitializeComponent();
        ...
        string verno;
        string[] verno1;
        private void sdict2_Load(object sender, EventArgs e)
        {
            string path = Application.StartupPath;
            richTextBox2.LoadFile(path + "\\dict\\5.rtf");
        ...
        {
            string path = Application.StartupPath;
            axWindowsMediaPlayer1.URL = path + "\\audio\\5.mp4";
        }

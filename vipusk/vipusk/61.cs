...
namespace vipusk
{
    public partial class _61 : Form
    {
        ...
        private void _61_Load(object sender, EventArgs e)
        {
            dataGridView2.ColumnCount = 2;
            dataGridView2.RowCount = k_voprosov_testa;
            string myXMLfile = Application.StartupPath + "\\xml\\6\\61.xml";

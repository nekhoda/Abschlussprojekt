...
namespace vipusk
{
    public partial class dict1 : Form
    {
        public dict1()
        {
            InitializeComponent();
        ...
        private void dict1_Load(object sender, EventArgs e)
        {
            string path = Application.StartupPath;
            richTextBox2.LoadFile(path+"\\dict\\1.rtf");
        ...
        {
             string path = Application.StartupPath;
            axWindowsMediaPlayer1.URL = path+ "\\audio\\1.mp4";
        }

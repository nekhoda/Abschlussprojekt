...
namespace vipusk
{
    public partial class _54 : Form
    {
        public _54()
        {
            InitializeComponent();
        }
        int vsego_voprosov_v_tabl = 20;
        ...
        private void _54_Load(object sender, EventArgs e)
        {
            dataGridView2.ColumnCount = 2;
            dataGridView2.RowCount = k_voprosov_testa;
            string myXMLfile = Application.StartupPath + "\\xml\\5\\54.xml";

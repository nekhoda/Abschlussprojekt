...
namespace vipusk
{
    public partial class _53 : Form
    {
        public _53()
        {
            InitializeComponent();
        }
        int vsego_voprosov_v_tabl = 15;
        ...
        private void _53_Load(object sender, EventArgs e)
        {
            dataGridView2.ColumnCount = 2;
            dataGridView2.RowCount = k_voprosov_testa;
            string myXMLfile = Application.StartupPath + "\\xml\\5\\53.xml";

...
namespace vipusk
{
    public partial class dict2 : Form
    {
        public dict2()
        {
            InitializeComponent();
        ...
        string verno;
        string[] verno1;
        private void dict2_Load(object sender, EventArgs e)
        {
            string path = Application.StartupPath;
            richTextBox2.LoadFile(path + "\\dict\\2.rtf");
        ...
        {
            string path = Application.StartupPath;
            axWindowsMediaPlayer1.URL = path + "\\audio\\2.mp4";
        }
    }
}

...
namespace vipusk
{
    public partial class _52 : Form
    {
        ...
        private void _52_Load(object sender, EventArgs e)
        {
            dataGridView2.ColumnCount = 1;
            dataGridView2.RowCount = k_voprosov_testa;
            string myXMLfile = Application.StartupPath + "\\xml\\5\\52.xml";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < k_voprosov_testa; i++)
            {
                if (dataGridView2[0, i].Value.ToString() == dataGridView1[1, mas[i]].Value.ToString())
                {
                    k++;
                    dataGridView2[0, i].Style.ForeColor = Color.Green;
                }
                else
                {
                    dataGridView2[0, i].Style.ForeColor = Color.Red;
                }
            }

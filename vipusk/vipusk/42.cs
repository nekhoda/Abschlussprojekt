...
namespace vipusk
{
    public partial class _42 : Form
    {
        ...
        private void _42_Load(object sender, EventArgs e)
        {
            listBox1.Items.Clear();
            listBox2.Items.Clear();
            listBox3.Items.Clear();
            string myXMLfile = Application.StartupPath + "\\xml\\4\\42.xml";

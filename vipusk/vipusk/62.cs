...
namespace vipusk
{
    public partial class _62 : Form
    {
        ...
        private void _62_Load(object sender, EventArgs e)
        {
            string myXMLfile = Application.StartupPath + "\\xml\\6\\62.xml";
